...
public class VoiceRecordActivity extends BaseActivity implements OnClickListener
{
		...
		public void run() {
            ...
            try {
				...
				try {
					...
					e.printStackTrace();
					showMessageToast("Por favor, inténtalo de nuevo", R.drawable.icon_speaker2);
					playSound("tryagain.wav");
				} catch (IOException e) {
					e.printStackTrace();
					showMessageToast("Por favor, inténtalo de nuevo", R.drawable.icon_speaker2);
					playSound("tryagain.wav");
	...
	private MediaRecorder.OnErrorListener errorListener = new MediaRecorder.OnErrorListener() {
		...
		public void onError(MediaRecorder mr, int what, int extra) {
			Toast.makeText(VoiceRecordActivity.this,
	...
	protected void displayPopup() {
		...
		titleSound.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				playSound("over_record_warning.ogg");	
				registry.getLog().logClick(title_sound++, "title_sound");
			}
